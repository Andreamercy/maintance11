...
enum RepairStaticData {
    ...
    static var repairTasks: [RepairTask] = [
        RepairTask(
            id: UUID(uuidString: "R1000001-0001-0001-0001-100000000001")!,
        ...
        RepairTask(
            id: UUID(uuidString: "R1000002-0002-0002-0002-100000000002")!,
        ...
        RepairTask(
            id: UUID(uuidString: "R1000003-0003-0003-0003-100000000003")!,
            assignedBy: "Admin – Raj Kumar",
            ...
            inventoryRequirements: [
                ...
                InventoryItem(id: UUID(), name: "Radiator Coolant", partNumber: "RC-001", quantity: 2, isAvailable: false)
            ],
            partsRequest: nil,
            history: [
        ...
        RepairTask(
            id: UUID(uuidString: "R1000004-0004-0004-0004-100000000004")!,
            assignedBy: "Admin – Priya Nair",
    ...
    static var serviceTasks: [ServiceTask] = [
        ServiceTask(
            id: UUID(uuidString: "S1000001-0001-0001-0001-200000000001")!,
            vehicleId: UUID(uuidString: "A1B2C3D4-0001-0001-0001-000000000001")!,
        ...
        ServiceTask(
            id: UUID(uuidString: "S1000002-0002-0002-0002-200000000002")!,
            vehicleId: UUID(uuidString: "A1B2C3D4-0003-0003-0003-000000000003")!,
